...
import com.lee.pojo.Menu;
import com.lee.pojo.Role;
import com.lee.pojo.User;
import com.lee.service.*;

import com.lee.util.CpachaUtil;
import com.lee.util.MenuUtil;
...
/*	@RequestMapping(value="/logout",method= RequestMethod.GET)
	public String logout(HttpServletRequest request){
		...
		String result = "redirect:http://"+request.getLocalAddr()+":"+request.getLocalPort()+request.getContextPath()+"/";
		//System.out.println(path1);
		//return "redirect:http://localhost:8080/liangxing/";
		return result;
	}*/
	/**
	 * 后台退出注销功能
